...
void sw::decode(){				//op1 and load value are extracted from the register file while offest (op2) is loaded from the immediate
...
void sw::access(){			//store loaded value into the calculated address in the data memory
