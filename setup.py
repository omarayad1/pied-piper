...
extension_mod.append(Extension("_addi", ["native/addi_wrap.cxx", "native/addi.cpp", "native/itype.cpp", "native/instruction.cpp", "native/data_mem.cpp"]))

extension_mod.append(Extension("_ble", ["native/ble_wrap.cxx","native/ble.cpp" ,"native/itype.cpp", "native/instruction.cpp", "native/data_mem.cpp"]))
extension_mod.append(Extension("_bne", ["native/bne_wrap.cxx", "native/bne.cpp", "native/itype.cpp", "native/instruction.cpp", "native/data_mem.cpp"]))
...
extension_mod.append(Extension("_load", ["native/load_wrap.cxx", "native/load.cpp", "native/itype.cpp", "native/instruction.cpp", "native/data_mem.cpp"]))
...
extension_mod.append(Extension("_store", ["native/store_wrap.cxx", "native/store.cpp", "native/itype.cpp", "native/instruction.cpp", "native/data_mem.cpp"]))
